Document = function () {
    this.getElementsByTagName = function (arg) {
        if (arg === 'head') {
            return [{}];
        }
    ...
    this.createElement = function (arg) {
        if (arg === 'div') {
            return {'onwheel': true};
        }
        if (arg === 'canvas') {
            return {
                'getContext': function (arg_inner) {
                    if (arg_inner === 'webgl2') {
                        return {};
                    }
                }
    ...
    this.attachEvent = function (arg1, arg2) {
        if (arg1 === 'onwheel') {
            return undefined;
        }
        return undefined;
    ...
    this.documentElement = function (arg) {
        return {'addBehavior': undefined};
    };
...
Window = function () {
    ...
    this.navigator = {"webdriver": false};
};
var window = new Window();

Navigator = function () {
    this.plugins = {};
    this.userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36";
...
var Location = function () {
    this.href = 'http://www.iwencai.com/';
    this.hostname = 'www.iwencai.com';
    this.host = 'www.iwencai.com';
    this.protocol = 'http:';
}
...
var TOKEN_SERVER_TIME = 1659438000.884;
!function (n, t) {
    !function () {
        var r, e, a;
        r = e = a = n;
...
function getCookieV() {
    var v = document.cookie.split('=')[1].split('; ')[0];
    v = 'v=' + v + ';';
    return v
}
